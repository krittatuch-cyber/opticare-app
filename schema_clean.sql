...
(1, 'Somchai', 'somchai@opticare.com', 'admin', '{"dashboard":true,"customers":true,"inventory":true,"pos":true,"appointments":true,"users":true,"reports":true,"settings":true}', 1),
(2, 'Dr. Naphat', 'naphat@opticare.com', 'optometrist', '{"dashboard":true,"customers":true,"inventory":false,"pos":false,"appointments":true,"users":false,"reports":false,"settings":false}', 1),
(3, 'Kanya', 'kanya@opticare.com', 'receptionist', '{"dashboard":true,"customers":true,"inventory":true,"pos":true,"appointments":true,"users":false,"reports":false,"settings":false}', 1),
(4, 'Siri', 'siri@opticare.com', 'receptionist', '{"dashboard":true,"customers":true,"inventory":true,"pos":true,"appointments":true,"users":false,"reports":false,"settings":false}', 2),
(5, 'Dr. Wittaya', 'wittaya@opticare.com', 'optometrist', '{"dashboard":true,"customers":true,"inventory":false,"pos":false,"appointments":true,"users":false,"reports":false,"settings":false}', 3);
